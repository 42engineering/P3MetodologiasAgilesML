...
The version used during training could not be installed correctly on Render, preventing the automatic reconstruction of technical indicators during inference.

## 7. Lessons Learned

* Environment reproducibility is a critical factor in Machine Learning projects.

---

## 8. Opportunities for Improvement

The following opportunities have been identified for future versions:
* Incorporate macroeconomic data and financial news.
* Implement sentiment analysis.
* Automate periodic model retraining.
* Add production performance monitoring.
* Develop a custom implementation of technical indicators using Pandas and NumPy to eliminate external dependencies.
...
For more detailed information, see the [README file](../../README.md).

---

## 10. Closing Conclusion

The project successfully achieved the o
