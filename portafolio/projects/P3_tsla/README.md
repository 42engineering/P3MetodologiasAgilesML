...
* ✅ [Notebook1](../P3_tsla/notebooks/PT3.1ColabV2E.ipynb) - Notebook implementation model

# Scripts
* ✅ [data_acquisition_tsla.py](../P3_tsla/scripts/data_acquisition/data_acquisition_tsla.py) - Data acqusition tsla stocks
...
* ✅ [Report final model](../P3_tsla/docs/modeling/model_report.md)  - Model report
* ✅ [Exit_report](../P3_tsla/docs/deployment/exit_report.md) - Exit report
