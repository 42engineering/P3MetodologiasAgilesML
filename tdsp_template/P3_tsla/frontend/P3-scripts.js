...
async function predictMovement() {
    ...
    resultBox.innerHTML = `
        <span class="result-kicker">Prediction Output</span>
    ...
    try {
        ...
        resultBox.innerHTML = `
            ...
            <p><b>Real Movement:</b> ${data.real_movement}</p>
            <p><b>Window Start:</b> ${data.window_start}</p>
            <p><b>Window End:</b> ${data.window_end}</p>
        `;
    } catch (error) {
        resultBox.innerHTML = `
            <span class="result-kicker">Prediction Output</span>
